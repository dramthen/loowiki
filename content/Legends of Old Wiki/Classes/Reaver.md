...
<div style="display: flex; align-items: center;">
  ...
  <div>
    <img src="Pasted image 20250703133405.png" alt="Reaver" style="max-width: 200px; height: auto; margin-left: 10px;">
  </div>
</div>
...
- Darkblade
	...
	- Effect: Applies a self only buff for x seconds during which all melee strikes trigger a magic damage effect that heals the player for the damage dealt
- Blood Sacrifice
	- Mana:
	- Cooldown: None
